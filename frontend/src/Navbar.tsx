  ...
  return (
    ...
    >
      <div className={cn(
        ...
        <Link to="/" className="text-xl sm:text-2xl font-extrabold text-dark flex items-center gap-2">
          <span className="bg-primary text-white w-8 h-8 sm:w-10 sm:h-10 flex items-center justify-center rounded-xl shadow-lg shadow-primary/30">P</span>
          <span className="inline">Pres<span className="text-primary">Code</span></span>
        </Link>
        ...
        <div className="hidden md:flex items-center gap-2 bg-slate-50/50 p-1.5 rounded-2xl border border-slate-100/50 relative">
          ...
          <button
            onClick={toggleTheme}
            className="p-2.5 rounded-xl bg-slate-50 dark:bg-slate-800 text-slate-600 dark:text-slate-300 hover:text-primary transition-all shadow-sm"
